...
var ProjectItem = function (_a) {
    ...
    var _f = react_1.useState({
        display: "block"
    }), imageState = _f[0], setImageState = _f[1];
    var isHovering = react_1.useRef(false);
    return (react_1["default"].createElement("div", { className: [ProjectItem_module_css_1["default"].ProjectItemContainer].join(" "), "data-aos": "fade-up" },
        react_1["default"].createElement("div", { className: ProjectItem_module_css_1["default"].ProjectItemContainerInner, onMouseEnter: function (e) {
            ...
            react_1["default"].createElement("div", { className: ProjectItem_module_css_1["default"].ProjectItemContainerInnerBack },
                react_1["default"].createElement("div", { style: { flex: 1, display: "flex", flexDirection: "column" } },
                    ...
                    react_1["default"].createElement("ul", null, project.description.map(function (d, i) {
                ...
                react_1["default"].createElement("div", { className: ProjectItem_module_css_1["default"].AccessContianer },
                    ((_b = project.links) === null || _b === void 0 ? void 0 : _b.github) ? (react_1["default"].createElement("a", { className: ProjectItem_module_css_1["default"].github, href: project.links.github, target: "_blank", rel: "noreferrer" },
                        react_1["default"].createElement(ai_1.AiFillGithub, { fontSize: "40" }))) : null,
                    ((_c = project.links) === null || _c === void 0 ? void 0 : _c.youtube) ? (react_1["default"].createElement("a", { className: ProjectItem_module_css_1["default"].youtube, href: project.links.youtube, target: "_blank", rel: "noreferrer" },
                        react_1["default"].createElement(ai_1.AiFillYoutube, { fontSize: "40" }))) : null,
                    ((_d = project.links) === null || _d === void 0 ? void 0 : _d.download) ? (react_1["default"].createElement("a", { className: ProjectItem_module_css_1["default"].download, href: project.links.download, target: "_blank", rel: "noreferrer" },
                        react_1["default"].createElement(ai_1.AiOutlineDownload, { fontSize: "40" }))) : null,
                    ((_e = project.links) === null || _e === void 0 ? void 0 : _e.visit) ? (react_1["default"].createElement("a", { className: ProjectItem_module_css_1["default"].visit, href: project.links.visit, target: "_blank", rel: "noreferrer" },
